...
export async function POST (request: Request){
    ...
    try{
        ...
        console.error("Se ha producido un error al guardar el estado del entrenamiento:", error)
        return Response.json({ error: "Error al cargar  el estado del entrenamiento"}, {status: 500})
    }
}